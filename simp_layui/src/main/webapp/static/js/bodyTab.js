...
//         console.log(window.sessionStorage.getItem("curmenu"));
//         
//         if(window.sessionStorage.getItem("menu")) {
...
// 	})
	...
	$("body").on("click",".top_tab li",function(){
        ...
        //2019年世界禁烟日修改bug
        if(window.sessionStorage.getItem("curmenu") != "undefined"){
             parent.cur_menu_id = JSON.parse(window.sessionStorage.getItem("curmenu")).id;
                console.log("赋值后=="+parent.cur_menu_id);
        }
	})
