...
layui.use(['element', 'layer', 'form', 'upload', 'treeGrid','application','publicUtil'], function () {
    var treeGrid = layui.treeGrid,
		...
		var treeTable =treeGrid.render({
	        ...
	        cols: [[
				{type:'checkbox',width:"4.1%"},			
	            {field:'name', title: '菜单名称',width:"20%"},
	            {field:'code', title: '菜单编码',width:"15%"},
				{field:'href', title: '菜单链接',width:"30%"},
				{field:'type', title: '菜单类型',width:"10%"},
				{field:'permission', title: '权限标记',width:"10%"},
	            {field:'isShow', title: '是否显示',width:"10%"}
	        ]]        
