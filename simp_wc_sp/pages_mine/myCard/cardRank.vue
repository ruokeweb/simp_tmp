<template>
    <view class="space">
        ...
        <view class="ranking_index">
            <view class="title_1"><text>领卡排行</text></view>
                ...
                <view v-show="num == 0">
                    <view class="tab_content_0 bottom_line">
                        <view class="ranking_list" style="position: absolute;left: 0;bottom: 56upx;" v-if="null!=ranking[1].smSchoolmate">
                            ...
                            <view class="name_text">
                                ...
                                <text class="name_text">第二名领卡</text>
                            </view>
                        </view>
                    ...
                    <view>
                        <view class="ranking_item bottom_line" v-for="(value, key) in order" :key="key">
                            ...
                            <text class="state_hao">第{{value.ranking}}名领卡</text>
                        </view>
                    </view>
    ...
    export default {
        ...
        onLoad(options) {
            ...
            if (options.cardId != undefined) {
                this.cardId = decodeURIComponent(options.cardId);
            }
        },
        computed: {
        ...
        onShareAppMessage(res) {
            ...
            expand.saveShare(app.share_code.CARDRANK_SHARE);
            return {
                title: this.school_name + '领卡排名',
                path: '/pages_mine/myCard/cardRank?cardId=' + this.cardId
            }
        },
        methods: {
            getNum(index) {
