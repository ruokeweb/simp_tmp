...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/card/card": {}, "pages/asso/asso": {}, "pages/activity/activity": {}, "pages/mine/mine": {}, "pages/login/login": {}, "pages/index/news/newsList": {}, "pages/index/news/newsContent": {}, "pages/register/introReg": {} }, "globalStyle": { "navigationBarBackgroundColor": "#0081ff", "navigationBarTitleText": "交大校友", "navigationStyle": "custom", "navigationBarTextStyle": "white" } };exports.default = _default;
...
/* 校友卡管理端 服务 （目前为模拟数据）*/
var serverPath = "https://ser.musichord.online";
//const serverPath ="http://127.0.0.1:8080";

var appId = "wx4489f983664ed068";
var openId = "openId";
var sessionKey = "sessionKey";

//首页通知部分
var noticeTime = "noticeTime";
var noticeStep = 1000 * 60 * 60 * 24 * 1; //步长一天
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _app = _interopRequireDefault(__webpack_require__(/*! @/common/app.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function getBaseDatas() {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _app.default.serverPath + '/app/auth/getBaseDatas', //仅为示例，并非真实接口地址。
      method: 'POST',
  ...
  return new Promise(function (resolve, reject) {
    uni.login({
      ...
      success: function success(loginRes) {
        ...
        //获取用户openid
        uni.request({
          url: _app.default.serverPath + "/app/auth/getOpenId",
          data: {
            'code': WxCode },
...
function autoLogin(openid) {
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _app.default.serverPath + "/app/auth/autoLogin",
      data: {
        'openId': openid },
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _crypto = _interopRequireDefault(__webpack_require__(/*! @/common/crypto */ 15));
...
function toPage(url) {
  if (url == "" || url == "undefined") {
    ...
    url = _app.default.MENU_PAGE.INDEX;
  }
  if (url == _app.default.MENU_PAGE.INDEX || url == _app.default.MENU_PAGE.MALL || url == _app.default.MENU_PAGE.COURSE || url == _app.default.MENU_PAGE.MINE) {
    uni.switchTab({
      url: url });
...
function isLogin() {
  ...
  var tokenTime = _index.default.state.tokenTime;
  var userInfo = uni.getStorageSync(_app.default.storageKey.userInfo);

  //token 过期时间判断
  var nowTokenTime = parseInt(tokenTime) + parseInt(_app.default.storageKey.tokenDate) * 24 * 60 * 1000;
  var nowTime = new Date().valueOf();
  var isUsed = nowTime - nowTokenTime - parseInt(_app.default.storageKey.tokenCycle) * 24 * 60 * 1000;

  //判断登录状态
  if (userInfo != "" && token != "" && isUsed > 0) {
    loginStatus = true;
    _index.default.commit('updateIsLogin', loginStatus);
  }
  if (isUsed <= 0) {
    _index.default.commit('updateIsLogin', loginStatus);
  }
...
function getDictByValue(value, typeCode) {
  if (value.length == 0 || typeCode.length == 0) {
    ...
    return uni.getStorageSync(_app.default.CACHE_NAME.DICTKV)[typeCode + value];
  }
}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    updateTokenTime: function updateTokenTime(state, tokenTime) {
      // ���״̬
...
var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /* 自行封装request请求 */
...
var http = function http(opt) {
  ...
  opt.header = {
    ...
    'Authorization': _index.default.state.token,
    'Time': keyTime,
...
/**刷新用户信息**/
var refreshUser = function refreshUser(opt) {
  http({
    url: _app.default.serverPath + "/app/auth/getUser",
    data: {},
    header: 'application/x-www-form-urlencoded',
    success: function success(res) {
      if (res.data.code == _app.default.RESPONSE_STATUS.REQUEST_SUCCESS) {
        //刷新整体缓存
        uni.setStorageSync(_app.default.storageKey.userInfo, res.data.data);
      }
    },
...
/**增加积分记录**/
var handleCredit = function handleCredit(operate, type, credit) {
  http({
    url: _app.default.serverPath + "/app/mine/handleCredit",
    data: {
      'operate': operate,
      'type': type,
      'credit': credit,
      'accountId': uni.getStorageSync(_app.default.storageKey.userInfo).sysAccount.id },
...

{
  ...
  handleCredit: handleCredit };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
