...
public class ExcelUtil{
	...
	public static Workbook exportExcelFile(List<?> list, Class<?> pojoClass,String title,String sheetName) {
		ExportParams exportParams = new ExportParams(title, sheetName);
		return  ExcelExportUtil.exportExcel(exportParams, pojoClass,
				list);
	}
