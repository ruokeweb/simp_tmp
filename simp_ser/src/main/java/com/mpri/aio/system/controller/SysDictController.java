...
public class SysDictController extends BaseController {
	...
	* @return
	...
	public RestResponse<String> save(@Validated SysDict sysDict){
		...
		//更新缓存
		redisCacheService.putCache(sysDictService, new SysDict() ,InitCache.DICT_BASE_CACHE,InitCache.DICT_CACHE);
...
//	@RequiresPermissions("sysdict:edit")
	...
	public  RestResponse<List<SysDict>> getSysDictByTypecode(String typeCode) {
		...
		dictList = (List<SysDict>) redisCacheService.getCacheByKey(InitCache.DICT_CACHE, typeCode);
		
		if(null!=dictList) {	
			return new RestResponse<List<SysDict>>(ExceptionResult.REQUEST_SUCCESS, "获取成功！", dictList);
