...
public class GenTemplateTest extends ApplicationTests {
	...
	public static final String TABLE = "sys_history_password";    //表名
	public static final String CLASSCOMMENT ="用户密码记录"; //模块名称
//	public static final String JAVA_URL = "E:\\";E:\\\\src\main
	public static final String JAVA_URL = "E:\\workspace\\simp\\simp_ser\\src\\main\\java\\";  // 物理路径       E:\git_res\AIO\AIO_SER\src\main\java
	public static final String XML_URL = "E:\\workspace\\simp\\simp_ser\\src\\main\\resources\\mapping\\";
	...
	public void creat(){
		...
		//作者名
		genConfigInfo.setAuthor("zdl");
		//项目名
		genConfigInfo.setProject("simp");
		//版本号
		genConfigInfo.setVersion("v_1.2");
		//请求url前缀
		genConfigInfo.setRequestUrl("sys/historyPassword");
