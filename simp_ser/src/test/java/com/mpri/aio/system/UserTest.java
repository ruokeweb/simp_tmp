...
public class UserTest extends ApplicationTests {
    ...
    public void test() {
        ...
        redisTemplate.opsForValue().set(su.getId(), su);
        
        SysUser user = (SysUser) redisTemplate.opsForValue().get(su.getId()); 
        
        //System.out.println(user.getId());
        redisTemplate.opsForHash().put("1000", su.getId(), user);
        //System.out.println(redisTemplate.opsForHash().get("1000", su.getId().toString())); 
        
        
//        List<SysDict> ls= (List<SysDict>) redisTemplate.opsForHash().get(InitData.dictCache, "USER_TYPE");
//        for(SysDict sd:ls) {
...
//        
    ...
    public void testUpdateUsers(){
			...
			SysUser su= new SysUser();
			su.setId("0b841061efed4cdcad356287e1e51b76");
			su.setFlag("0");
			su.setEmail("@123.com");
			su.setUsername("guest");
			su.setMobile("10000");
			//su.setName("test");
			//su.setOrgId("0");
			...
			su.setSafecode(safecode);
			//加盐炒三次safecode=salt
			String result = new Md5Hash("guest",safecode,3).toString();
			su.setPassword(result);
			//su.setPhoto("");
			su.setRemark("nothing");
			//su.setType("0");
